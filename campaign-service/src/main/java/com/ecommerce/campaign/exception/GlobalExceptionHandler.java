...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleCampaignNotFound(CampaignNotFoundException exception,
                                                            HttpServletRequest request) {
        log.warn("Campaign not found on {}: {}", request.getRequestURI(), exception.getMessage());
