...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleSellerNotFound(SellerNotFoundException exception,
                                                          HttpServletRequest request) {
        log.warn("Seller not found on {}: {}", request.getRequestURI(), exception.getMessage());
